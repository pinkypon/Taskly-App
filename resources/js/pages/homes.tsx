...
const Toast = ({
    ...
    return (
        <div className="fixed top-4 right-4 z-50 duration-300 animate-in fade-in slide-in-from-top-2">
            <div
                className={`${bgColor} flex max-w-sm items-center gap-3 rounded-lg px-6 py-4 text-white shadow-lg`}
            >
                <div className="flex-shrink-0">{icon}</div>
                <p className="text-sm font-medium">{message}</p>
                <button
                    onClick={onClose}
                    className="ml-auto flex-shrink-0 text-white/80 transition-colors hover:text-white"
                >
            ...
            <main className="animate-fade-in-up mx-auto mt-10 max-w-6xl px-4">
                ...
                <div className="mb-5">
                    <div className="flex items-center gap-x-2">
                        ...
                        <Header className="inline-block rounded-lg p-2">
                            Your Tasks
                        </Header>
                    </div>
                    <p className="mt-1 text-gray-600">
                        Manage and track your daily activities efficiently.
                    </p>
                </div>
